...
> Documento de visión: el qué y el para qué, no el cómo. Establece el propósito y
> los principios que gobiernan qué debe ser Hercolega. El diseño de cada pieza vive
> en los documentos de /docs que lo acompañan, ya con esta visión como marco.
...
- **Conocimiento validado** — qué se sabe que funciona: la metodología, la
  experiencia destilada. Resiste. Es el suelo firme.
...
## 2. El principio rector: la autoridad es del fundador
...
## 3. El mantra: la finalidad es la acción bien fundada

> No hay nada más práctico que una buena teoría — pero la teoría hay que validarla
> en tu entorno: tu emprendimiento.

La acción bien fundada combina dos contextos inseparables: el **conocimiento
...
experiencia, la experiencia se vuelve conocimiento del entorno, y ese conocimiento
funda la siguiente acción. No es una flecha; es un ciclo.

---

## 4. El papel de la IA: ayudar a saber de qué fiarse

Una IA generalista responde cualquier cosa con el mismo tono seguro: lo validado y
lo tentativo suenan igual de convincentes. La IA bien usada hace lo contrario —
marca lo que sabe de lo que no. No da certezas falsas; da un mapa honesto del
conocimiento, con sus zonas firmes y sus zonas en construcción.

Esta honestidad epistémica es el corazón técnico del sistema: la distinción
`Verified` / `Emerging` atraviesa el conocimiento y llega marcada hasta la respuesta
que lee el fundador. En un mundo donde el conocimiento caduca rápido, no es un lujo:
es la única forma de no construir sobre arena.

---

## 5. El colega, en su forma plena
...
mejorarla"** es el principio rector en acción: la historia es del fundador; el
colega le da visión para escribir los siguientes capítulos mejor, sin escribirlos
por él.

Y ese colega no es estático, en dos sentidos que marcan la dirección del proyecto:

- **Crece hacia nuevas fronteras.** Hoy es experto en construir una empresa. Mañana,
  esa frontera puede ser cómo operar sobre los sistemas operativos de IA (AIOS), o
  cómo innovar cuando las reglas se reescriben — ejemplos de lo que probablemente
...
honestidad que el sistema aplica a su conocimiento.

---

## 6. La arquitectura que lo encarna

La visión se sostiene sobre un reparto deliberado, unido por un estándar abierto.

**El conocimiento, en el centro.** Vive en un servicio central **sin estado**: sabe
de metodología, no de ninguna startup, y no guarda datos de nadie. Se organiza en
especialistas —ideación, MVP, encaje producto-mercado, escalado, plataformas,
operaciones, gobernanza— y distingue en cada respuesta lo validado de lo emergente.

**El estado, en el borde.** El emprendedor instala un **agente personal** en su
entorno, un producto abierto bajo su control. Aporta la conversación, la memoria de
la startup y la privacidad: los datos se quedan donde el fundador decide. La memoria
vive aquí, distribuida, nunca en el centro.

**La conexión, por un estándar que nadie posee.** El conocimiento se expone al
agente por **MCP** (Model Context Protocol), el estándar abierto para dar
capacidades a agentes de IA. Desacopla el conocimiento de cualquier agente concreto:
el emprendedor usa el que prefiera y le conecta el conocimiento sin candados.

El estado vive en el borde, privado; el conocimiento en el centro, sin estado; y el
fundador decide donde ambos se funden en acción. El detalle de qué razona dónde está
en *Dónde piensa cada cosa*.
...
- *Dónde piensa cada cosa* — el reparto de inteligencia entre el centro y el borde.
- *Diseño del servidor MCP* — cómo se expone el conocimiento como herramientas.
- *El mecanismo OKF-grafo* — la recuperación determinista de conocimiento.
- *La expansión de especialistas* — cómo crece el sistema de especialistas.
- *ontology-engine* — el servicio de estructura de la ontología.
- *Verificación del ciclo completo* — la prueba de que la memoria cambia el consejo.

La cara pública, con la visión funcional y la técnica: **hercolega.com**.
